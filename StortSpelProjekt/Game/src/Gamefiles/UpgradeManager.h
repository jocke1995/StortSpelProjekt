...
enum E_UpgradeIDs
{
	...
	UPGRADE_MELEE_LIFESTEAL = 4,
	UPGRADE_BLUE_JEWEL = 5,
	UPGRADE_RANGE_BOUNCE = 6,
	UPGRADE_POISON_ATTACK = 7,
	UPGRADE_KNOCKBACK = 8,
	UPGRADE_HEALTH_REGEN = 9,
	UPGRADE_RANGE_DAMAGE = 10,
	UPGRADE_MELEE_ATTACKSPEED = 11,
	UPGRADE_RANGE_ATTACKSPEED = 12,
	UPGRADE_EXPLOSIVE_ATTACK = 13,
	UPGRADE_MELEE_RADIUS = 14
};
